...
void			GameClient::run()
{
  ...
  _bg_tex.loadFromImage(jag::getRessource(Network::getPath(Network::RsrcDir, "TicTacToe") + "blackboard.jpg"));
  _bg.setTexture(_bg_tex);
  _line.setFillColor(sf::Color::White);
  _font.loadFromFile(Network::getPath(Network::RsrcDir, "TicTacToe") + "PWChalk.ttf");
